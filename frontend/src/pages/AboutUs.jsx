  ...
  return (
    <div className="min-h-screen w-full flex flex-col overflow-x-hidden bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 font-sans text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-12 md:py-16">
        ...
        {/* Developers Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Our Development Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow text-center">
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-indigo-400 to-violet-400 flex items-center justify-center overflow-hidden">
                <img 
                  src="https://via.placeholder.com/128?text=Dev1" 
                  alt="Developer 1" 
                ...
                />
                <div className="hidden w-full h-full bg-gradient-to-br from-indigo-400 to-violet-400 text-white text-4xl font-bold items-center justify-center">
                  D1
                </div>
              </div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Developer 1</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Full Stack Developer</p>
            </div>

            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow text-center">
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-indigo-400 to-violet-400 flex items-center justify-center overflow-hidden">
                <img 
                  src="https://via.placeholder.com/128?text=Dev2" 
                  alt="Developer 2" 
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.style.display = 'none';
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Developer 2</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Full Stack Developer</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow text-center">
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-indigo-400 to-violet-400 flex items-center justify-center overflow-hidden">
                <img 
                  src="https://via.placeholder.com/128?text=Dev3" 
                  alt="Developer 3" 
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.style.display = 'none';
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Developer 3</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Full Stack Developer</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow text-center">
              <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-indigo-400 to-violet-400 flex items-center justify-center overflow-hidden">
                <img 
                  src="https://via.placeholder.com/128?text=Dev4" 
                  alt="Developer 4" 
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.style.display = 'none';
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Developer 4</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Full Stack Developer</p>
            </div>
          </div>
        </section>
