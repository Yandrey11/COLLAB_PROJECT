                ...
                >
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 mb-4">
                      ...
                      <div className="flex gap-3">
                        <button
                          onClick={() => updateSetting("display", "uiDensity", "compact")}
                          className={`flex-1 p-4 rounded-lg border-2 transition-all ${
                            settings.display.uiDensity === "compact"
                              ? "border-indigo-500 dark:border-indigo-400 bg-indigo-50 dark:bg-indigo-900/20"
                              : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600"
                          }`}
                        >
                          <div className="text-center">
                            <div className="font-semibold text-sm text-gray-900 dark:text-gray-100">Compact</div>
                            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">More items per page</div>
                          </div>
                        </button>
                        <button
                          onClick={() => updateSetting("display", "uiDensity", "normal")}
                          className={`flex-1 p-4 rounded-lg border-2 transition-all ${
                            settings.display.uiDensity === "normal"
                              ? "border-indigo-500 dark:border-indigo-400 bg-indigo-50 dark:bg-indigo-900/20"
                              : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600"
                          }`}
                        >
                          <div className="text-center">
                            <div className="font-semibold text-sm text-gray-900 dark:text-gray-100">Normal</div>
                            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Standard spacing</div>
                          </div>
                        </button>
                      </div>
                    </div>
